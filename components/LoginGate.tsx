...
import { checkDeviceTrust, startGoogleAuth, generateFingerprint } from '../utils/fingerprint';
    ...
    useEffect(() => {
        const checkAuth = async () => {
            ...
            if (result.trusted && result.user) {
                ...
                setAuth(prev => ({ ...prev, checking: false }));
            }
        };
            ...
            <div className="h-screen w-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <div className="mt-8 text-xs text-slate-600">
                        <p>Your device will be remembered for automatic login</p>
                    </div>
                </div>
            </div>
        );
